...
class Trainer:
    ...
    def train(self, train_loader, criterion, dev_loader, epochs=100, steps=20,
              divide_rate=0.2, high=0.85, low=0.15, generation_threshold=0.15, switched_train_loader=False,
              freeze_neurons=True):
